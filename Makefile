...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/10/20 14:56:26 by fnaciri-          #+#    #+#              #
#    Updated: 2019/10/30 15:40:27 by fnaciri-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_B = ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstsize_bonus.c ft_lstadd_back_bonus.c ft_lstlast_bonus.c \
